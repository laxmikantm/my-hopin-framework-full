...
describe("Basic Customer search", () =>{
  ...
  it("Able to search", function()  {
    ...
    cy.get('tbody>tr>td>a:first-child').should('equals', cy.fixture('example').its('customers').its(0).its('name'))
    console.log('DEBUG, Output ->', cy.fixture('example').its('customers').its(0).its('name'))
  })
